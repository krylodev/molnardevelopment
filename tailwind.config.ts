	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				'red-transparent': 'rgba(230, 57, 70, 0.3)',
				'red-transparent-light': 'rgba(230, 57, 70, 0.2)',
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			keyframes: {
				...
				'particle-float': {
					...
					'100%': {
						transform: 'translateY(-100vh) translateX(var(--random-x)) scale(0.7)',
						opacity: '0'
					}
				},
				'gradient-shift': {
				...
				'glow': {
					'0%, 100%': { 
						boxShadow: '0 0 20px rgba(230, 57, 70, 0.2), 0 0 40px rgba(230, 57, 70, 0.1)' 
					},
					'50%': { 
			...
			animation: {
				...
				'float-circle': 'float-circle 5s ease-in-out infinite',
